...
```
Questo progetto riguarda la stima dei parametri di una funzione sulla base di misure sperimentali accoppiate indipendenti. Il riferimento è al capitolo 7 di Cowan.
...
Il metodo LS si dovrà applicare, quando possibile, nella sua forma analitica (Cowan eq. 7.10; Cowan 7.8 per il valore del chi2) o altrimenti utilizzando una minimizzazione numerica (per esempio con scipy.optimize.curve_fit() ); in quest'ultimo caso il chi2 verrà calcolato utilizzando la sua definizione 7.3.
```
